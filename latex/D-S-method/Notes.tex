...
We now compute $\operatorname{curl}^*\operatorname{curl}$ in 2D. We can write curl as
\begin{equation}
	\operatorname{curl}
	=
	\begin{bmatrix*}[r]
	...
	\end{bmatrix*},
\end{equation}
then from \cref{eqn:grad-perp,eqn:curl-grad-perp}
\begin{equation}
	\operatorname{curl}^*
	=
	\begin{bmatrix*}[r]
...
\end{equation}
By taking into account commutativity of time and spatial derivatives we obtain
\begin{equation}
	\operatorname{curl}^*\left(\frac{\partial}{\partial t}\right)\operatorname{curl}\psi=-\frac{\partial}{\partial t}\left(\nabla^2 \psi \right)
\end{equation}
Finally, we compute
\begin{align}
	\operatorname{curl}^*\operatorname{grad}^2\operatorname{curl}\psi
	&=\begin{bmatrix*}[r]
	\frac{\partial}{\partial y}&
	-\frac{\partial}{\partial x}
	\end{bmatrix*}
