...
\subsubsection{Derivation of Type II ABC}\label{subsubsec:non-reflecting-abc}
...
After applying the discrete operators listed in the next subsections, we rewrite \cref{eqn:NSE-dsm-bl-system-schemes}  as
